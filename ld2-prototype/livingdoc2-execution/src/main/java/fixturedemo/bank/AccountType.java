...
public enum AccountType {
    ...
    SAVINGS("savings", Money.getMoney(200f), Money.getMoney(200f), null, Money.getMoney(1.5f), Money.getMoney(2.5f),
        Money.getMoney(0.5f)),
    CHECKING("checking", Money.getMoney(200f), Money.getMoney(200f), null, Money.getMoney(0), Money.getMoney(2.50f),
        Money.getMoney(0));
    ...
    AccountType(String description, Money limitBankMachine, Money limitInteracMachine, Money limitPersonalCheck,
